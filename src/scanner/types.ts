...
export type Batch = {
  ...
  sanitization: { modified: boolean; invisibleCharsRemoved: number; injectionPatternsNeutralized: number };
...
export function toSummary(finding: Finding): FindingSummary {
  return {
    id: finding.id,
